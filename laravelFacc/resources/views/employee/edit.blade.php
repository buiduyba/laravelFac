@extends('master')
@section('title')
    Update nhân viên ID: {{ $employee->id }}
@endsection
@section('content')
    <h1>
        Update nhân viên ID: {{ $employee->id }}
    ...
    <div class="container">
        <form method="POST" action="{{ route('employee.update', $employee) }}" enctype="multipart/form-data">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-8">
                    <input type="text" class="form-control" name="first_name" id="first_name"
                        value="{{ $employee->first_name }}" placeholder="Name" />
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-8">
                    <input type="text" class="form-control" name="last_name" id="last_name"
                        value="{{ $employee->last_name }}" placeholder="Name" />
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-8">
                    <input type="checkbox" class="form-checkbox" @checked($employee->is_active) value="1"
            ...
            <div class="mb-3 d-flex justify-content-center">
                ...
                <div class="col-8">
                    <select class="form-select form-select-sm" name="department_id" id="department_id">
                        <option selected value="{{ $employee->department_id }}">{{ $employee->department_id }}</option>
